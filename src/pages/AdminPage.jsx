    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-center">Вход в панель администратора</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="rememberMe">Запомнить меня на этом компьютере</Label>
              </div>
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>{editMode ? 'Редактировать объект' : 'Добавить новый объект'}</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleAddOrEditProperty} className="space-y-6">
